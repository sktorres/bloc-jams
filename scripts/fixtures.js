...
var myAlbum = {
    ...
    label: 'XL',
    year: '2007',
    albumArtUrl: 'assets/images/album_covers/rainbows.jpg',
    songs: [
        { name: '15 Step', length: '1:01' },
        { name: 'Bodysnatchers', length: '5:01' },
        { name: 'Weird Fishes', length: '3:21' },
        { name: 'Nude', length: '3:14' },
        { name: 'All I Need', length: '2:15' }
    ]
};